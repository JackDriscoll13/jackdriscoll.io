...
const Footer: React.FC = () => {
    return (
        ...
        <div className="container mx-auto flex justify-center items-center space-x-6 mt-2">
          ...
          <a href="https://github.com/JackDriscoll13" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
          ...
          <a href="https://www.linkedin.com/in/jack-driscoll-3026721a0/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
